...
(function() {
  var handleScriptQueue, lineHeight, lineWidth, loadScript, loadScriptQueue, miniserv_url;
  ...
  handleScriptQueue = function() {
    var script;
    if (loadScriptQueue.length > 0) {
      script = document.createElement('script');
      script.onload = function() {
        if (loadScriptQueue.length > 0) {
          return handleScriptQueue();
        }
      };
      script.src = loadScriptQueue.shift();
      return document.getElementsById('head')[0].appendChild(script);
    }
  };
  ...
  yak.bindings.add({
    ...
    "C-M-j": {
      onkeydown: function() {
        return loadScript("" + miniserv_url + "/files/jquery.js");
      }
    }
  });
